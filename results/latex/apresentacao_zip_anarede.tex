...
\begin{frame}{Conclusões Principais}
  \begin{enumerate}
    ...
    \item Os ramos mais afetados foram aqueles próximos às barras com maior variação angular e de tensão.
  \end{enumerate}
\end{frame}
